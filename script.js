function changeMajor() {
  ...
  title.textContent = "BACHELOR OF SECONDARY EDUCATION – " + major;
}
...
function saveAsImage() {
  ...
  // 2. Replace all <input type="text"> with <span> (preserving line breaks)
